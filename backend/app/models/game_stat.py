...
class GameStat(Base):
    ...
    koalitionsbruch: Mapped[bool] = mapped_column(Boolean(), nullable=False, server_default="false")
    ...
    arbeitslosigkeit_final: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
    ...
    opt_in_community: Mapped[bool] = mapped_column(Boolean(), nullable=False, server_default="false")
