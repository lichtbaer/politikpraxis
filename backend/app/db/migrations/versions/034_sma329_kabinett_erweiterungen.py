...
def upgrade() -> None:
    op.add_column(
        "chars",
        sa.Column(
            "ist_partner_minister", sa.Boolean(), nullable=False, server_default="false"
        ),
    )
    op.add_column(
        "chars",
        sa.Column(
            "agenda_stufe_aktuell", sa.Integer(), nullable=True, server_default="0"
        ),
    )
    op.add_column(
        "chars",
        sa.Column(
            "agenda_ablehnungen", sa.Integer(), nullable=False, server_default="0"
        ),
    )
