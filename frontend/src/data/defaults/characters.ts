...
export const DEFAULT_CHARACTERS: Character[] = [
  {
    ...
    mood: 3, loyalty: 5, tag: 'Stabilität',
  ...
  },
  {
    ...
    mood: 1, loyalty: 2, tag: 'Sicherheit',
  ...
  },
  {
    ...
    mood: 4, loyalty: 4, tag: 'Rechtsstaat',
