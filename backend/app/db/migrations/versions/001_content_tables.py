...
def upgrade() -> None:
    ...
    # ENUMs
    content_locale = postgresql.ENUM(
        "de", "en", name="content_locale", create_type=True
    )
    ...
    op.create_index(
        "ix_chars_i18n_char_id_locale", "chars_i18n", ["char_id", "locale"], unique=True
    )
    ...
    op.create_table(
        "gesetze_i18n",
        sa.Column(
            "gesetz_id", sa.Text(), sa.ForeignKey("gesetze.id"), primary_key=True
        ),
        sa.Column(
            "locale",
            postgresql.ENUM("de", "en", name="content_locale", create_type=False),
    ...
    op.create_index(
        "ix_gesetze_i18n_gesetz_id_locale",
        "gesetze_i18n",
        ["gesetz_id", "locale"],
        unique=True,
    )
    ...
    op.create_index(
        "ix_events_i18n_event_id_locale",
        "events_i18n",
        ["event_id", "locale"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "followup_event_id", sa.Text(), sa.ForeignKey("events.id"), nullable=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "choice_id",
            sa.Integer(),
            sa.ForeignKey("event_choices.id"),
            primary_key=True,
        ),
        sa.Column(
            "locale",
    ...
    op.create_index(
        "ix_event_choices_i18n_choice_id_locale",
        "event_choices_i18n",
        ["choice_id", "locale"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "fraktion_id",
            sa.Text(),
            sa.ForeignKey("bundesrat_fraktionen.id"),
            primary_key=True,
        ),
        sa.Column(
            "locale",
    ...
    op.create_table(
        ...
        sa.Column(
            "tradeoff_id",
            sa.Integer(),
            sa.ForeignKey("bundesrat_tradeoffs.id"),
            primary_key=True,
        ),
        sa.Column(
            "locale",
