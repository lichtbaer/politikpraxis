...
def upgrade() -> None:
    ...
    op.create_table(
        "eu_events_i18n",
        sa.Column(
            "event_id", sa.Text(), sa.ForeignKey("eu_events.id"), primary_key=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "kofinanzierung", sa.Numeric(4, 2), nullable=True, server_default="0"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "choice_id",
            sa.Integer(),
            sa.ForeignKey("eu_event_choices.id"),
            primary_key=True,
        ),
        sa.Column("locale", sa.String(5), primary_key=True),
