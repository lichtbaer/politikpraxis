...
def upgrade() -> None:
    ...
    op.add_column(
        "chars",
        sa.Column("ist_kanzler", sa.Boolean(), nullable=False, server_default="false"),
    )
    ...
    ministers = [
        ...
        (
            ...
            4,
            4,
            {"prioritaeten": ["mindestlohn", "tarifbindung"]},
        ),
        (
            "sdp_gm",
            "sdp",
            ...
            3,
            4,
            {"prioritaeten": ["pflege", "krankenversicherung"]},
        ),
        (
            "sdp_im",
            "sdp",
            ...
            3,
            3,
            {"prioritaeten": ["sicherheit", "integration"]},
        ),
        (
            "sdp_bm",
            "sdp",
            ...
            3,
            4,
            {"prioritaeten": ["chancengleichheit", "ausbildung"]},
        ),
        ...
        (
            ...
            2,
            3,
            {"prioritaeten": ["schuldenbremse", "haushaltsdisziplin"]},
        ),
        (
            "cdp_im",
            "cdp",
            ...
            1,
            2,
            {"prioritaeten": ["innere_sicherheit", "migration"]},
        ),
        (
            "cdp_wm",
            "cdp",
            ...
            4,
            4,
            {"prioritaeten": ["wirtschaftswachstum", "industrie"]},
        ),
        (
            "cdp_jm",
            "cdp",
            ...
            4,
            4,
            {"prioritaeten": ["rechtsstaat", "grundrechte"]},
        ),
        (
            "cdp_bm",
            "cdp",
            ...
            3,
            3,
            {"prioritaeten": ["bildung", "forschung"]},
        ),
        # GP (6)
        ...
        (
            ...
            3,
            3,
            {"prioritaeten": ["klimaschutz", "energiewende"]},
        ),
        (
            "gp_wm",
            "gp",
            ...
            4,
            4,
            {"prioritaeten": ["nachhaltigkeit", "kreislaufwirtschaft"]},
        ),
        (
            "gp_fm",
            "gp",
            ...
            3,
            3,
            {"prioritaeten": ["gruene_investitionen", "klimafinanzierung"]},
        ),
        (
            "gp_jm",
            "gp",
            ...
            4,
            4,
            {"prioritaeten": ["buergerrechte", "umweltrecht"]},
        ),
        (
            "gp_im",
            "gp",
            ...
            3,
            3,
            {"prioritaeten": ["demokratieschutz", "versammlungsrecht"]},
        ),
        # LDP (6)
        ...
        (
            ...
            4,
            4,
            {"prioritaeten": ["steuerreform", "schuldenabbau"]},
        ),
        (
            "ldp_wm",
            "ldp",
            ...
            4,
            4,
            {"prioritaeten": ["digitalisierung", "innovation"]},
        ),
        (
            "ldp_jm",
            "ldp",
            ...
            3,
            3,
            {"prioritaeten": ["buergerrechte", "wirtschaftsrecht"]},
        ),
        (
            "ldp_im",
            "ldp",
            ...
            3,
            3,
            {"prioritaeten": ["datenschutz", "freiheitsrechte"]},
        ),
        (
            "ldp_bm",
            "ldp",
        ...
        (
            ...
            3,
            3,
            {"prioritaeten": ["umverteilung", "vermoegensteuer"]},
        ),
        (
            "lp_am",
            "lp",
            ...
            4,
            4,
            {"prioritaeten": ["arbeitnehmerrechte", "mindestlohn"]},
        ),
        (
            "lp_jm",
            "lp",
            ...
            4,
            4,
            {"prioritaeten": ["soziale_gerechtigkeit", "antidiskriminierung"]},
        ),
        (
            "lp_wm",
            "lp",
            ...
            3,
            3,
            {"prioritaeten": ["wohnungsbau", "mietpreisbremse"]},
        ),
        (
            "lp_im",
            "lp",
            ...
            3,
            3,
            {"prioritaeten": ["frieden", "abruestung"]},
        ),
    ]
