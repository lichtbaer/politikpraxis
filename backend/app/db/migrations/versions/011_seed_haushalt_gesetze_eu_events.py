...
def upgrade() -> None:
    ...
    gesetze_i18n_en = [
        (
            "sondervermoegen_klima",
            "Climate Protection Special Fund",
            "SVK",
    ...
    eu_events_i18n_de = [
        (
            ...
            '„Brüssel verlangt verbindliche Mindestlohnstandards."',
        ...
        (
            ...
            '„Sorgfaltspflichten entlang der Lieferkette werden Pflicht."',
        ...
        (
            "eu_rl_klima",
            "EU-Klimaschutz-Verschärfung",
            '„Die Klimaziele werden verschärft — Deutschland muss nachziehen."',
        ...
        (
            ...
            '„Rechtspopulistische Parteien gewinnen in mehreren Mitgliedstaaten."',
        ...
        (
            ...
            '„Paris und Berlin müssen gemeinsame Positionen finden."',
        ...
        (
            "europawahl",
            "Europawahl",
            '„Die Europawahl hat stattgefunden — die Ergebnisse liegen vor."',
    ...
    choices_data = [
        ...
        (
            ...
            0.20,
            "Sofort umsetzen",
            "Vollständige Umsetzung. Kofinanzierung 20%, GBD +8.",
            "EU-Mindestlohn-Richtlinie vollständig umgesetzt.",
        ),
        (
            "eu_rl_mindestlohn",
            "minimal_umsetzen",
            ...
            0.10,
            "Minimal umsetzen",
            "Wirkung -30%, Kofinanzierung 10%. BdI -5.",
            "EU-Mindestlohn-Richtlinie minimal umgesetzt.",
        ),
        (
            "eu_rl_mindestlohn",
            "klagen",
            ...
            "Klage gegen EU-Mindestlohn-Richtlinie eingereicht.",
        ),
        # eu_rl_lieferkette
        (
            "eu_rl_lieferkette",
            ...
            0.20,
            "Sofort umsetzen",
            "Vollständige Umsetzung der Lieferketten-Richtlinie.",
            "EU-Lieferketten-Richtlinie umgesetzt.",
        ),
        (
            "eu_rl_lieferkette",
            "minimal_umsetzen",
            ...
            0.10,
            "Minimal umsetzen",
            "Minimale Umsetzung, Wirkung -30%.",
            "EU-Lieferketten-Richtlinie minimal umgesetzt.",
        ),
        (
            "eu_rl_lieferkette",
            "klagen",
            ...
            "Klagen",
            "12 Monate Aufschub, 30% Erfolgschance.",
            "Klage gegen EU-Lieferketten-Richtlinie eingereicht.",
        ),
        # eu_rl_klima
        (
            "eu_rl_klima",
            ...
            0.35,
            "Sofort umsetzen",
            "Kofinanzierung 35%. Vollständige Anpassung.",
            "EU-Klimaverschärfung umgesetzt.",
        ),
        (
            "eu_rl_klima",
            "minimal_umsetzen",
            ...
            0.15,
            "Minimal umsetzen",
            "Minimale Anpassung, Wirkung -30%.",
            "EU-Klimaverschärfung minimal umgesetzt.",
        ),
        (
            "eu_rl_klima",
            "klagen",
            ...
            "Klagen",
            "12 Monate Aufschub, 30% Erfolgschance.",
            "Klage gegen EU-Klimaverschärfung eingereicht.",
        ),
        # eu_rechtsruck
        (
            "eu_rechtsruck",
            ...
            "Reagieren",
            "Koalitionspartner +5.",
            "Regierung reagiert auf Rechtsruck in Europa.",
        ),
        (
            "eu_rechtsruck",
            "neutral",
            ...
            "Neutral",
            "Keine Stellungnahme.",
            "Regierung nimmt keine Position ein.",
        ),
        (
            "eu_rechtsruck",
            "gegenposition",
            ...
            0.0,
            "Gegenposition",
            "EU-Klima +5 in 2 Feldern.",
            "Regierung bezieht Gegenposition zum Rechtsruck.",
        ),
        # eu_gipfel_frankreich
        (
            "eu_gipfel_frankreich",
            ...
            0,
            0.0,
            "Thema A vorantreiben",
            "Priorität auf ein Verhandlungsthema.",
            "Deutsch-Französischer Gipfel: Thema A priorisiert.",
        ),
        (
            "eu_gipfel_frankreich",
            "thema_b",
            ...
            0,
            0.0,
            "Thema B priorisieren",
            "Priorität auf anderes Verhandlungsthema.",
            "Deutsch-Französischer Gipfel: Thema B priorisiert.",
        ),
        (
            "eu_gipfel_frankreich",
            "beide_neutral",
            ...
            "Deutsch-Französischer Gipfel ohne Durchbruch.",
        ),
        # europawahl
        (
            "europawahl",
            ...
            "Kein Trade-off.",
            "Europawahl-Ergebnis zur Kenntnis genommen.",
        ),
    ]
    ...
    conn.execute(
        sa.text("SELECT setval('eu_event_choices_id_seq', :max_id)"),
        {"max_id": choice_id - 1},
    )
...
def downgrade() -> None:
    ...
    for eid in eu_event_ids:
        ...
        conn.execute(
            sa.text("DELETE FROM eu_event_choices WHERE event_id = :eid"), {"eid": eid}
        )
        conn.execute(
            sa.text("DELETE FROM eu_events_i18n WHERE event_id = :eid"), {"eid": eid}
        )
