...
def upgrade() -> None:
    ...
    for gid, tags, bt, ea, eh, eg, ez, lag, foed, iw, ig, is_, pf in gesetze_data:
    ...
    gesetze_i18n_en = [
        ...
        (
            "grundrechte",
            "Fundamental Rights Strengthening Act",
            "GrSG",
    ...
    ministerial_i18n_de = [
        (
            "wolf_klimaschutz",
            "Klimaschutzsofortprogramm",
            "Wolf initiiert das Klimaschutzsofortprogramm.",
            '„Wenn wir jetzt nicht handeln, wird es zu spät sein."',
        ),
        (
            "braun_sicherheit",
            "Innere-Sicherheit-Paket",
            "Braun bringt das Innere-Sicherheit-Paket ein.",
            '„Die Bürger erwarten mehr Sicherheit."',
        ),
        (
            "lehmann_buerokratie",
            "Bürokratieabbau",
            "Lehmann initiiert das Bürokratieabbau-Gesetz.",
            '„Weniger Bürokratie bedeutet mehr Wachstum."',
        ),
        (
            "maier_ki",
            "KI-Fördergesetz",
            "Maier bringt das KI-Förder- und Regulierungsgesetz ein.",
            '„Deutschland muss bei KI vorne dabei sein."',
        ),
        (
            "kern_grundrechte",
            "Grundrechtsstärkung",
            "Kern initiiert das Grundrechtsstärkungsgesetz.",
    ...
    ministerial_i18n_en = [
        (
            ...
            "Wolf initiates the climate protection emergency programme.",
            "„If we don't act now, it will be too late.\"",
        ),
        (
            "braun_sicherheit",
            "Domestic Security Package",
            "Braun introduces the domestic security package.",
            '„Citizens expect more security."',
        ),
        (
            "lehmann_buerokratie",
            "Bureaucracy Reduction",
            "Lehmann initiates the bureaucracy reduction act.",
            '„Less bureaucracy means more growth."',
        ),
        (
            "maier_ki",
            "AI Promotion Act",
            "Maier introduces the AI promotion and regulation act.",
            '„Germany must be at the forefront of AI."',
        ),
        (
            "kern_grundrechte",
            "Fundamental Rights Strengthening",
            "Kern initiates the fundamental rights strengthening act.",
