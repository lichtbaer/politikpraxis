...
const DEFAULT_MILIEUS: ContentBundle['milieus'] = [
  ...
  { id: 'buergerliche_mitte', ideologie: { wirtschaft: 10, gesellschaft: 15, staat: -10 }, min_complexity: 2, gewicht: 22, basisbeteiligung: 78, kurz: 'Bürg. Mitte', beschreibung: 'Wirtschaftlich orientierte Mittelschicht mit bürgerlichen Werten und hoher Wahlbeteiligung.' },
  ...
  { id: 'traditionelle', ideologie: { wirtschaft: -5, gesellschaft: 55, staat: -40 }, min_complexity: 2, gewicht: 8, basisbeteiligung: 62, kurz: 'Tradition', beschreibung: 'Traditionelle Mittelschicht mit moderater Beteiligung und konservativen Grundwerten.' },
];
...
const DEFAULT_AGENDA_ZIELE: AgendaZielContent[] = [
  ...
  },
  {
    ...
    titel: 'Investieren statt verwalten',
    beschreibung: '',
  },
  {
    id: 'ag_milieu_mitte',
  ...
  {
    id: 'ag_haushalt_solide',
    kategorie: 'haushalt',
    schwierigkeit: 3,
    partei_filter: null,
    min_complexity: 1,
    bedingung_typ: 'haushalt_saldo_min',
    bedingung_param: { min_saldo_mrd: -20, min_monate_am_stueck: 12 },
    titel: 'Solide Kasse',
    beschreibung: '',
  },
  {
    id: 'ag_kabinett_geschlossen',
    kategorie: 'kabinett',
    schwierigkeit: 2,
    partei_filter: null,
    min_complexity: 1,
    bedingung_typ: 'char_mood_min_durchschnitt',
    bedingung_param: { min_avg_mood: 3.5 },
    titel: 'Geschlossenes Kabinett',
    beschreibung: '',
  },
  {
    id: 'ag_medien_klima',
    ...
    bedingung_param: { schwelle: 55, min_monate: 12 },
    titel: 'Freundliche Presse',
    beschreibung: '',
  },
];
