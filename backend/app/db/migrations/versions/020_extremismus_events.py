...
def upgrade() -> None:
    ...
    events_i18n_de = [
        (
            ...
            "Koalition",
            "Koalitionspartner besorgt über Regierungskurs",
        ...
        (
            ...
            "Verfassung",
            "Verfassungsgericht nimmt Klage gegen Regierungshandeln an",
    ...
    choices_data = [
        ...
        (
            ...
            None,
            "Kurs korrigieren",
            "Wir nehmen die Kritik ernst und justieren unsere Positionen.",
        ...
        (
            ...
            "10 PK — Intensives Gespräch mit dem Koalitionspartner.",
            "Koalitionsgespräch einberufen.",
        ),
        (
            "koalitionspartner_extremismus_warnung",
        ...
        (
            ...
            5,
            2,
            "Mit dem Gericht kooperieren",
            "Wir respektieren den Rechtsstaat und arbeiten konstruktiv mit.",
        ...
        (
            ...
            "15 PK — Rechtliche Verteidigung der Regierungsposition.",
    ...
    events_i18n_en = [
        (
            "koalitionspartner_extremismus_warnung",
            "Coalition",
            "Coalition partner concerned about government course",
        ...
        (
            "verfassungsgericht_klage",
            "Constitution",
            "Constitutional Court accepts lawsuit against government actions",
    ...
    choices_i18n_en = [
        (
            choice_id - 6,
            "Correct course",
            "We take the criticism seriously and adjust our positions.",
            "Course corrected — coalition partner reassured.",
        ),
        (
            choice_id - 5,
            "Convene coalition talks",
            "10 PK — Intensive discussion with the coalition partner.",
        ...
        (
            ...
            "We respect the rule of law and work constructively.",
            "Cooperation with Constitutional Court announced.",
        ),
        (
            choice_id - 2,
            "Defend in court",
            "15 PK — Legal defence of the government position.",
            "Government defends course before Constitutional Court.",
        ),
        (
            choice_id - 1,
            "Announce constitution-compliant reform",
