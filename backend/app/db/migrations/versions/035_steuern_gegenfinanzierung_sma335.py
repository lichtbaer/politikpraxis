...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "typ IN ('direkt', 'indirekt', 'co2')", name="steuern_typ_check"
        ),
    )
    ...
    for sid, name, typ, aktuell, min_s, max_s, basis, pro_proz, sens, minc in steuern:
        conn.execute(
            ...
            """),
            {
                ...
                "name": name,
                "typ": typ,
                "aktuell": aktuell or None,
                "min_s": min_s or None,
                "max_s": max_s or None,
                "basis": basis or None,
                "pro_proz": pro_proz or None,
                "sens": sens,
                "minc": minc,
            },
        )
    ...
    gesetze_i18n_de = [
        (
            "est_plus_2",
            "Einkommensteuer-Erhöhungsgesetz",
            "ESt+2",
    ...
    gesetze_i18n_en = [
        ...
        (
            "co2_plus_25",
            "CO2 Price Increase Act",
            "CO2+25",
            "Raising CO2 pricing by 25 €/tonne.",
        ),
        (
            "vermoegensteuer_einfuehren",
            "Wealth Tax Reintroduction Act",
            "WT",
            "Reintroduction of a wealth tax on high assets.",
        ),
        (
            "digitalsteuer_einfuehren",
            "Digital Tax Introduction Act",
            "DT",
