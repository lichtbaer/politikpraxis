...
def upgrade() -> None:
    ...
    events_i18n_de = [
        ...
        (
            "haushaltsstreit_opposition",
            "Haushaltskritik",
            "Opposition greift Haushaltspolitik an",
    ...
    events_i18n_en = [
        (
            "steuerstreit_koalition",
            "Coalition dispute",
            "Coalition dispute over tax policy",
    ...
    choices_steuerstreit = [
        (
            ...
            "Koalitionspartner einbinden, KV gestärkt.",
            "Kompromiss gefunden.",
            "Negotiate compromise",
            "Include coalition partner, strengthen agreement.",
            "Compromise found.",
        ),
        (
            "steuerstreit_koalition",
    ...
    choices_haushalt = [
        (
            ...
            3,
            "Öffentlich kontern",
            "Medienklima verbessert.",
            "Öffentlich kontert.",
            "Counter publicly",
            "Media climate improves.",
            "Publicly countered.",
        ),
        (
            "haushaltsstreit_opposition",
...
def downgrade() -> None:
    ...
    conn.execute(
        sa.text(
            "UPDATE gesetze SET investiv = FALSE, min_complexity = 1 WHERE id = 'schuldenbremse_reform'"
        )
    )
