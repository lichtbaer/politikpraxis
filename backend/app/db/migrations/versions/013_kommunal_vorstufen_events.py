...
def upgrade() -> None:
    ...
    kommunal_i18n_de = [
        (
            "kommunal_klima_initiative",
            "Kommunal-Initiative",
            "Hamburg und München starten Klimaschutz-Eigenprogramm",
        ...
        (
            "kommunal_sozial_initiative",
            "Kommunal-Initiative",
            "Ruhrgebiet-Städte fordern Mindestlohnerhöhung — jetzt",
        ...
        (
            "kommunal_sicherheit_initiative",
            "Kommunal-Initiative",
            "Städte fordern mehr Polizeipräsenz — eigenständige Maßnahmen",
    ...
    vorstufen_i18n_de = [
        (
            ...
            "Vorstufen-Erfolg",
            "Pilotprojekt [Stadtname]: Erfolg bestätigt",
        ...
        (
            ...
            "Vorstufen-Erfolg",
            "[Bundesland] beschließt [Gesetz] — Signalwirkung für Bund",
    ...
    kommunal_choices = [
        ...
        (
            ...
            "Kommunale Initiative als Vorbild gewürdigt. Positive Signalwirkung.",
        ),
        (
            "kommunal_klima_initiative",
            "koordinieren",
            ...
            "Bund koordiniert kommunale Initiative. Pilotprojekt gestartet.",
        ),
        (
            "kommunal_klima_initiative",
            "ignorieren",
            ...
            "Kommunale Initiative ignoriert. Unmut in den Städten.",
        ),
        # kommunal_sozial_initiative
        (
            "kommunal_sozial_initiative",
            ...
            "Als Vorbild würdigen",
            "+2% BT-Stimmen für passende Gesetze, keine PK-Kosten.",
            "Kommunale Initiative als Vorbild gewürdigt.",
        ),
        (
            "kommunal_sozial_initiative",
            "koordinieren",
            ...
            8,
            "Koordinieren und Pilot starten",
            "8 PK — voller Kommunal-Pilot.",
            "Bund koordiniert. Pilotprojekt gestartet.",
        ),
        (
            "kommunal_sozial_initiative",
            "ignorieren",
            ...
            "Ignorieren",
            "Keine Reaktion.",
            "Kommunale Initiative ignoriert.",
        ),
        # kommunal_sicherheit_initiative
        (
            "kommunal_sicherheit_initiative",
