...
|---|---|---|---|
| ✅ | **Trivy-Failure beheben**: `pip install --upgrade pip setuptools` im Backend-Image (msgpack kommt als pip-Vendor mit, setuptools 70.3 ist CVE-2025-47273). PR #423 liegt bereits vor und sollte als Erstes gemergt werden. *(umgesetzt auf `claude/project-quality-plan-y9fqgf`, identisch zu #423)* | `backend/Dockerfile` | S |
